...
class CycleGANModel(BaseModel):
    ...
    def backward_G(self):
        ...
        self.loss_idt_A = self.criterionCycle(self.real_A, self.fake_A_BC)
        self.loss_idt_B = self.criterionCycle(self.real_B, self.fake_B_BC)
        self.loss_idt_C = self.criterionCycle(self.real_C, self.fake_C_BC)
        self.loss = self.loss_idt_C + self.loss_idt_B + self.loss_idt_A + self.loss_vgg
        # GAN loss D_B(G_BC(A))
